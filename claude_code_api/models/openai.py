...
class ToolFunction(BaseModel):
    ...
    parameters: Dict[str, Any] = Field(..., description="The JSON schema for the function parameters")
...
class ToolCallDelta(BaseModel):
    ...
    function: Optional[ToolCallFunctionDelta] = Field(None, description="Function delta")
...
class ChatMessage(BaseModel):
    ...
    tool_call_id: Optional[str] = Field(None, description="Tool call ID this tool message is responding to")
...
class ChatCompletionRequest(BaseModel):
    ...
    tools: Optional[List[ToolDefinition]] = Field(None, description="Tools available for the model to call")
    tool_choice: Optional[Union[str, ToolChoice]] = Field(
        None, description="Tool choice preference (e.g. 'auto', 'none', or a specific tool)"
    )
...
class ChatCompletionChunkDelta(BaseModel):
    ...
    tool_calls: Optional[List[ToolCallDelta]] = Field(None, description="Tool call deltas")
